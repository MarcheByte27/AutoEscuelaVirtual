...
include_once("../cabecera.php")
	?>
		...
		<ul style="list-style-type: none">
			<li class="user"><strong><?php echo  $dniA ?></strong></li>
			<li class="log_out"><form action="../logout.php"><input  type="submit" name="cerrar_sesion" value="CERRAR SESIÓN"></form></li>
		</ul>
	<form>
		<div class="ppl_up">
			<center>
				<input class="tests" type="submit" name="tests" value="Tests" formaction="tests.php">
				<input class="notas" type="submit" name="Notas" value="Notas" formaction="tabla_notas.php">
				<input class="exam" type="submit" name="exam" value="Exámen" formaction="tabla_examenes.php">
				<input class="nosotrosA" type="submit" name="nosotros" value="Nosotros" formaction="nosotros_alumno.php">
			</center>
		</div>
		<div>
		...
		<div class="ppl_down">
			<input class="prof" type="submit" name="profesores" value="Profesores" formaction="tabla_profesores.php">
			<input class="hora" type="submit" name="horarios" value="Horarios" formaction="horarios.php">
			<input class="material_extra" type="submit" name="material_ex" value="Material Extra" formaction="material_extra.php">
		</div>
	</form>
